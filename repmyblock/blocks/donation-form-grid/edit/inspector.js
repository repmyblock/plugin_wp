 ...
 */
import walkthecountyFormOptions from '../data/options';
		...
		<InspectorControls key="inspector">
			<PanelBody title={ __( 'Form Grid Settings' ) }>
				...
				<SelectControl
					...
					name="orderBy"
					value={ orderBy }
					options={ walkthecountyFormOptions.orderBy }
					onChange={ ( value ) => saveSetting( 'orderBy', value ) } />
				<SelectControl
					label={ __( 'Order' ) }
					name="order"
					value={ order }
					options={ walkthecountyFormOptions.order }
				...
				<SelectControl
					...
					name="columns"
					value={ columns }
					options={ walkthecountyFormOptions.columns }
				...
				<SelectControl
					...
					name="displayType"
					value={ displayType }
					options={ walkthecountyFormOptions.displayType }
