 ...
 */
import walkthecountyDonorWallOptions from '../data/options';
		...
		<InspectorControls key="inspector">
			<PanelBody title={ __( 'Donor Wall Settings' ) }>
				...
				<SelectControl
					...
					name="orderBy"
					value={ orderBy }
					options={ walkthecountyDonorWallOptions.orderBy }
					onChange={ ( value ) => saveSetting( 'orderBy', value ) } />
				<SelectControl
					label={ __( 'Order' ) }
					name="order"
					value={ order }
					options={ walkthecountyDonorWallOptions.order }
					onChange={ ( value ) => saveSetting( 'order', value ) } />
				<SelectControl
					label={ __( 'Columns' ) }
					name="columns"
					value={ columns }
					options={ walkthecountyDonorWallOptions.columns }
