<?php
/**
 * WalkTheCounty Donation Form Block Class
 *
...
/**
 * WalkTheCounty_Donation_Form_Block Class.
 *
 * This class handles donation forms block.
 *
 * @since 2.0.2
 */
class WalkTheCounty_Donation_Form_Block {
	/**
	 * Instance.
	 *
	 * @since
	 * @access private
	 * @var WalkTheCounty_Donation_Form_Block
	 */
	 ...
	 * @since
	 * @access public
	 * @return WalkTheCounty_Donation_Form_Block
	 */
	...
	private function init() {
		...
		add_action( 'wp_ajax_walkthecounty_block_donation_form_search_results', array( $this, 'block_donation_form_search_results' ) );
	}
	...
	public function register_block() {
		...
		// Register block.
		register_block_type(
			'walkthecounty/donation-form', array(
	...
	public function block_donation_form_search_results() {
		...
		$forms_query = new WalkTheCounty_Forms_Query(
			array(
				's'           => $search_keyword,
				'number'      => 30,
				'post_status' => 'publish',
...
WalkTheCounty_Donation_Form_Block::get_instance();
