...
/**
 * Class WalkTheCounty_DB_Log_Meta
 *
 * This class is for interacting with the log meta database table.
 *
 * @since 2.0
 */
class WalkTheCounty_DB_Log_Meta extends WalkTheCounty_DB_Meta {
	/**
	 * Meta supports.
	 *
	 * @since  2.0
	...
	/**
	 * WalkTheCounty_DB_Log_Meta constructor.
	 *
	 * @access  public
	 * @since   2.0
	 */
	public function __construct() {
		...
		$wpdb->logmeta     = $this->table_name = $wpdb->prefix . 'walkthecounty_logmeta';
