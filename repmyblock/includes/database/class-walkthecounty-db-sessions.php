...
/**
 * Class WalkTheCounty_DB_Sessions
 */
class WalkTheCounty_DB_Sessions extends WalkTheCounty_DB {
	/**
	 * Cache group name
	 *
	 * @since  2.2.0
	 ...
	 * @var string
	 */
	private $cache_group = 'walkthecounty_sessions';
	 ...
	 * @var string
	 */
	private $incrementer_name = 'walkthecounty_sessions';
	...
	public function __construct() {
		global $wpdb;
		$this->table_name  = "{$wpdb->prefix}walkthecounty_sessions";
		$this->primary_key = 'session_key';
		$this->version     = '1.0';

		// Set cache group id.
		$current_blog_id        = get_current_blog_id();
		$this->incrementer_name = "walkthecounty-cache-incrementer-sessions-{$current_blog_id}";
