...
if ( ! class_exists( 'TCPDF' ) ) {
	if ( file_exists( WALKTHECOUNTY_PLUGIN_DIR . 'vendor/tecnickcom/tcpdf/tcpdf.php' ) ) {
		require_once WALKTHECOUNTY_PLUGIN_DIR . 'vendor/tecnickcom/tcpdf/tcpdf.php';
	} else {
		// Load autoloader.
		require_once WALKTHECOUNTY_PLUGIN_DIR . 'includes/libraries/tcpdf/tcpdf.php';
	}
}

/**
 * Class WalkTheCounty_PDF
 */
class WalkTheCounty_PDF extends TCPDF {
