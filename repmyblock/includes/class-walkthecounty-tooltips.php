 ...
 * @subpackage  Classes/WalkTheCounty_Tooltips
 * @copyright   Copyright (c) 2017, WalkTheCountyWP
 * @license     https://opensource.org/licenses/gpl-license GNU Public License
 * @since       2.0
 */
class WalkTheCounty_Tooltips {
	/**
	...
	public function render( $args ) {
		...
		return sprintf( '<%1$s %2$s rel="tooltip">%3$s</%1$s>', $args['tag'], walkthecounty_get_attribute_str( $args['attributes'] ), $args['tag_content'] );
	}
	...
	function render_help( $args ) {
		...
		$args['tag_content']         = '<i class="walkthecounty-icon walkthecounty-icon-question"></i>';
		$args['attributes']['class'] = 'walkthecounty-tooltip';
