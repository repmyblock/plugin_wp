<?php
/**
 * WalkTheCounty - Stripe Core | Stripe Log View Class
 *
...
/**
 * WalkTheCounty_Stripe_Log_Table List Table Class
 *
 * Renders the stripe log list table
 *
 * @since 2.5.8
 */
class WalkTheCounty_Stripe_Log_Table extends WP_List_Table {
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			case 'ID':
				return sprintf(
					'<span class="walkthecounty-item-label walkthecounty-item-label-gray">%1$s</span>',
	...
	public function column_details( $item ) {
		echo wp_kses_post(
			WalkTheCounty()->tooltips->render_link(
				array(
					'label'       => __( 'View Stripe Log', 'walkthecounty' ),
	 ...
	 *
	 * @see    : https://github.com/WordImpress/WalkTheCounty/issues/564
	 *
	 * @since  2.5.0
	 * @access protected
	 *
	 ...
	 * @access public
	 * @since  2.0.8
	 * @uses   WalkTheCounty_Stripe_Log_Table::get_columns()
	 * @uses   WP_List_Table::get_sortable_columns()
	 * @uses   WalkTheCounty_Stripe_Log_Table::get_pagenum()
	 * @uses   WalkTheCounty_Stripe_Log_Table::get_logs()
	 * @uses   WalkTheCounty_Stripe_Log_Table::get_log_count()
	 *
	 * @return void
	 */
	public function prepare_items() {
		...
		$total_items           = WalkTheCounty()->logs->get_log_count( 0, 'stripe' );
