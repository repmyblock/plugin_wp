 ...
 * @subpackage  Classes/WalkTheCounty_Stats
...
class WalkTheCounty_Stats {
	 ...
	 * Class Constructor
	 *
	 * Set up the WalkTheCounty Stats Class.
	 *
	 * @since  1.0
	 * @access public
	 *
	...
	public function get_predefined_dates() {
		$predefined = array(
			'today'        => esc_html__( 'Today', 'walkthecounty' ),
			'yesterday'    => esc_html__( 'Yesterday', 'walkthecounty' ),
			'this_week'    => esc_html__( 'This Week', 'walkthecounty' ),
			'last_week'    => esc_html__( 'Last Week', 'walkthecounty' ),
			'this_month'   => esc_html__( 'This Month', 'walkthecounty' ),
			'last_month'   => esc_html__( 'Last Month', 'walkthecounty' ),
			'this_quarter' => esc_html__( 'This Quarter', 'walkthecounty' ),
			'last_quarter' => esc_html__( 'Last Quarter', 'walkthecounty' ),
			'this_year'    => esc_html__( 'This Year', 'walkthecounty' ),
			'last_year'    => esc_html__( 'Last Year', 'walkthecounty' ),
		);

		return apply_filters( 'walkthecounty_stats_predefined_dates', $predefined );
	}
	...
	public function convert_date( $date, $end_date = false ) {
		...
		if ( array_key_exists( (string) $date, $this->get_predefined_dates() ) ) {
			...
			return new WP_Error( 'invalid_date', esc_html__( 'Improper date provided.', 'walkthecounty' ) );
		...
		return apply_filters( 'walkthecounty_stats_date', $date, $end_date, $this );
