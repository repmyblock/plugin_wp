 ...
 * @return string
 */
function walkthecounty_get_current_setting_tab() {
	// Get current setting page.
	$current_setting_page = walkthecounty_get_current_setting_page();
	 ...
	 * @param string
	 */
	$default_current_tab = apply_filters( "walkthecounty_default_setting_tab_{$current_setting_page}", 'general' );
 ...
 * @return string
 */
function walkthecounty_get_current_setting_section() {
	// Get current tab.
	 ...
	 * @param string
	 */
	$default_current_section = apply_filters( "walkthecounty_default_setting_tab_section_{$current_tab}", '' );
 ...
 * @return string
 */
function walkthecounty_get_current_setting_page() {
	// Get current page.
 ...
 * @return array
 */
function walkthecounty_get_settings_groups() {

	$current_section = walkthecounty_get_current_setting_section();

	return apply_filters( 'walkthecounty_get_groups_' . $current_section, array() );
}
