...
/**
 * WalkTheCounty_Batch_Export Class
 *
 * @since 1.5
 */
class WalkTheCounty_Batch_Export extends WalkTheCounty_Export {
	...
	public function __construct( $_step = 1 ) {
		...
		$this->filetype = '.csv';
		$this->filename = 'walkthecounty-' . $this->export_type . $this->filetype;
	...
	public function process_step() {
		...
		if ( ! $this->can_export() ) {
			wp_die( esc_html__( 'You do not have permission to export data.', 'walkthecounty' ), esc_html__( 'Error', 'walkthecounty' ), array(
				'response' => 403,
			) );
		}
	...
	public function export() {
		 ...
		 * @since 1.8
		 */
		do_action( 'walkthecounty_file_export_complete', $_REQUEST );
